...
namespace ManagedX.Win32
{
	...
	public enum StatusCode : int
	{
		...
		[SuppressMessage( "Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Dxgi" )]
		[Source( "WinError.h", "DXGI_STATUS_NO_REDIRECTION" )]
		...
		[SuppressMessage( "Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Dxgi" )]
		[Source( "WinError.h", "DXGI_STATUS_NO_DESKTOP_ACCESS" )]
		...
		[SuppressMessage( "Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Dxgi" )]
		[Source( "WinError.h", "DXGI_STATUS_GRAPHICS_VIDPN_SOURCE_IN_USE" )]
		...
		/// </summary>
		[SuppressMessage( "Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Dxgi" )]
		[Source( "WinError.h", "DXGI_STATUS_MODE_CHANGED" )]
		DxgiModeChanged = 0x087A0007,

		/// <summary><code>IDXGISwapChain.ResizeTarget</code> and <code>IDXGISwapChain.SetFullscreenState</code> will return this value if a fullscreen/windowed mode transition is occurring when either API is called.</summary>
		[SuppressMessage( "Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Dxgi" )]
		[Source( "WinError.h", "DXGI_STATUS_MODE_CHANGE_IN_PROGRESS" )]
		...
		[Source( "WinError.h", "DXGI_STATUS_UNOCCLUDED" )]
		...
		[Source( "WinError.h", "DXGI_STATUS_DDA_WAS_STILL_DRAWING" )]
		...
		[SuppressMessage( "Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Dxgi" )]
		[Source( "WinError.h", "DXGI_STATUS_PRESENT_REQUIRED" )]
		...
		/// <summary></summary>
		[Source( "AudioClient.h", "AUDCLNT_S_BUFFER_EMPTY" )]
		AudioClientBufferEmpty = 0x08890001,

		/// <summary></summary>
		[Source( "AudioClient.h", "AUDCLNT_S_THREAD_ALREADY_REGISTERED" )]
		AudioClientThreadAlreadyRegistered = 0x08890002,

		/// <summary></summary>
		[Source( "AudioClient.h", "AUDCLNT_S_POSITION_STALLED" )]
		AudioClientPositionStalled = 0x08890003,
		...
		/// <summary>This callback and state have already been passed in to this event generator earlier.</summary>
		[Source( "MFError.h", "MF_S_MULTIPLE_BEGIN" )]
		MediaFoundationMultipleBegin = 0x000D36D8,
